...
def findID(img, desList, thresh=25):
...
while True:
    ...
    id, kp2, matchList = findID(img2, desList)
    if id != -1:
        cv2.putText(imgOri, "Type : " + classNames[id], (50,50), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255), 2)
    
    
    cv2.putText(imgOri, "N_Point : " + str(matchList[id]), (50,200), cv2.FONT_HERSHEY_PLAIN, 2, (255,0,0), 2)
    ...
    # img_match = cv2.drawMatchesKnn(imgCur, kp, img2, kp2, matches[:50], None, flags=2)
